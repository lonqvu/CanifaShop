...
const Analytics = () => {
    ...
    const getOrderByMonth = (page, year, month) => {
        StatisTicalService.getOrderByMonth(page, year, month)
            .then((response) => {
    ...
    const getCategoryParent = () => {
        CategoryService.getCategoryParentAdmin().then((response) => {
            setCategoryParent(response.data.data)
            console.log(response.data.data)
        })
    }
    const getCategoryByParentId = (startTime, endTime, parentId) => {
        StatisTicalService.getRevenueByCate(startTime, endTime, parentId).then(
            (response) => {
    ...
    const count = ()=>{
        StatisTicalService.getCount(startTime, endTime, 'COMPLETED').then(res=>{
            setCountComplete(res.data)
        })
        StatisTicalService.getCount(startTime, endTime, 'RESOLVED').then(res=>{
            setCountShip(res.data)
        })
        StatisTicalService.getCount(startTime, endTime, 'CANCELED').then(res=>{
    ...
    const getRevenueTop10User = () => {
        StatisTicalService.getRevenueTop10User(startTime, endTime).then(
            (response) => {
    ...
    const getRevenueTop3Product = () => {
        StatisTicalService.getRevenueTop5Product(startTime, endTime).then(
            (response) => {
    ...
    const getRevenueTop5Cate = () => {
        StatisTicalService.getRevenueTop5Cate(startTime, endTime).then(
            (response) => {
    ...
    const getRevenueByQuantity = () => {
        StatisTicalService.getRevenueByQuantity(startTime, endTime).then(
            (response) => {
    ...
    const getRevenueByComplete = () => {
        StatisTicalService.getRevenueByComplete(startTime, endTime).then(
            (response) => {
    ...
    const getRevenueByCancel = () => {
        StatisTicalService.getRevenueByCancel(startTime, endTime).then(
            (response) => {
                setStatusOrder(response.data)
            }
        )
            ...
            >
                <Grid item xs={12}>
                    ...
                    >
                        ...
                        >
                            <Tab label="Tổng thống kê" {...a11yProps(0)} />
